...
DataGenerator_img_disk.__init__(self, self, img_dir, label_dir = None, label_cols:list = None, validate_filenames:bool = True, batch_size = 8, class_mode:str = 'categorical', classes:list=None, **kwargs)
DataGenerator_img_disk.__len__(self)
DataGenerator_img_disk.get_img_gen(self)
