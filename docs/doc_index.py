...
gensim_model_load(dirin, filein = 'fasttext', modeltype = 'fastext', **kw)
gensim_model_train_save(model = None, dirinput = 'lee_background.cor', dirout = "./modelout/", fileout = 'fasttext', epochs = 1, pars: dict  =  None, **kw)
help()
np_str_to_array(vv, l2_norm = True, mdim = 200)
test_gensim1()
