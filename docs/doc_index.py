...
-------------------------functions----------------------
_ark(actual: list, predicted: list, k = 10)
_mean_ranking_metric(y, labels, metric)
_require_positive_k(k)
_single_list_similarity(predicted: list, feature_df: pd.DataFrame, u: int)
_warn_for_empty_labels()
catalog_coverage(predicted: List[list], catalog: list)
coverage_at_k(y_preds, product_data, k = 3)
get_testdata()
help()
hit_rate_at_k(y_preds, y_test, k = 3)
hit_rate_at_k_nep(y_preds, y_test, k = 3)
intra_list_similarity(predicted: List[list], feature_df: pd.DataFrame)
mark(actual: List[list], predicted: List[list], k = 10)
...
novelty(predicted: List[list], pop: dict, u: int, n: int)
personalization(predicted: List[list])
...
recommender_precision(predicted: List[list], actual: List[list])
recommender_recall(predicted: List[list], actual: List[list])
