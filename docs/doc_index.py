...
custom_loss(y_true, y_pred)
log(*s)
loss_total_function(x, x_recon, z_mean, z_logsigma, kl_weight = 0.00005, y_label_heads = None, y_pred_heads = None, clf_loss_fn = None)
...
prepro_image(image_path: str, xdim:int = 1, ydim:int = 1)
prepro_images(image_path_list: list, prepro_image_fun = None, npool = 1)
test()
...
os_copy(dirin:str = None, dirout:str = None, nlevel = 5, nfile = 50000, logdir = "./", pattern = "*", cmd_fallback = "")
os_copy_safe(dirin:str = None, dirout:str = None, nlevel = 5, nfile = 50000, logdir = "./", pattern = "*", cmd_fallback = "")
os_cpu()
os_file_check(fp)
