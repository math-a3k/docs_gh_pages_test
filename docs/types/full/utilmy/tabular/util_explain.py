...
def model_save(model: Union[RuleFitRegressor, SLIMRegressor, FIGSRegressor], path: Optional[str]=None, info: None=None) -> None:
...
def model_load(path: str="") -> Union[RuleFitRegressor, SLIMRegressor, FIGSRegressor]:
    import cloudpickle as pickle
...
def model_evaluate(model: Union[RuleFitRegressor, SLIMRegressor, FIGSRegressor], data_pars:dict) -> None:
    """ Evaluate model
    """
    d = Box(data_pars) if data_pars is not None else Box({})
...
def model_extract_rules(model: Union[RuleFitRegressor, SLIMRegressor, FIGSRegressor]) -> None:
