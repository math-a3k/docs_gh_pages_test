...
def gensim_model_load(dirin, filein='fasttext', modeltype='fastext', **kw):
    """
...
def gensim_model_train_save(model=None, dirinput='lee_background.cor', dirout="./modelout/", fileout='fasttext',
