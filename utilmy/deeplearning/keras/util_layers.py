...
from tensorflow.keras.layers import Conv2D, Add, BatchNormalization, MaxPool2D, Layer, GlobalAveragePooling2D, Dropout, Input, Dense
...
class ResBlock(Layer):
    ...
    def __init__(self, filters, kernels):
        try:
            ...
            sys.exit('AssertionError: Please make sure that filters and kernels attribute in ResBlock are lists of 2 elements each')
