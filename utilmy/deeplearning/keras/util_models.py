...
def test_classactivation():
    """
    Summary: test the network activation
    """
    pass
...
class GradCAM:
    """
    This is a class for Gradient-weighted Class Activation Mapping 
    ...
    def __init__(self, model, classIdx, layerName=None):
        """
        Summary: The constructor for GradCAM class.
    ...
    def find_target_layer(self):
        """
        Summary: Find the final convolutional layer in the network
    ...
    def overlay_heatmap(self, heatmap, image, alpha=0.5,
        ...
        """
        Summary: Overlay the heatmap over original image
        ...
        Returns:
        heatmap (data_type):
        output (data_type): overlayed heatmap
        """
